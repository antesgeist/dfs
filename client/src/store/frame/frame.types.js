const FrameActionTypes = {
    ...
    APPEND_TO_PARENT_NODE: 'frame/APPEND_TO_PARENT_NODE',
    APPEND_CHILD_NODE: 'frame/APPEND_CHILD_NODE',
    APPEND_SIBLING_NODE: 'frame/APPEND_SIBLING_NODE',
    ...
    DRAG_CHILD_NODE: 'frame/DRAG_CHILD_NODE'
}
